...
import { KeyValuePairType, OwnerType } from '@lib/types/svtpTaskContextType';

type FormikCreateTaskType = {
...
function TaskModal({
	...
	const ref = useRef<FormikProps<CreateTaskType> | any >({ values: initialValues });
